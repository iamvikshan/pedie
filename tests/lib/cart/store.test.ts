...
function makeListing(overrides: Partial<ListingWithProduct> = {}): ListingWithProduct {
  return {
    id: '1',
    listing_id: 'PD-00001',
    product_id: 'PROD-001',
...
describe('CartStore', () => {
  ...
  test('addListing allows different listing_ids', () => {
    ...
    const listing2 = makeListing({ id: '2', listing_id: 'PD-00002', price_kes: 30000 })
  ...
  test('clearCart empties the cart', () => {
    ...
    useCartStore.getState().addListing(makeListing({ id: '2', listing_id: 'PD-00002' }))
  ...
  test('getTotal sums all price_kes values', () => {
    useCartStore.getState().addListing(makeListing({ listing_id: 'PD-00001', price_kes: 50000 }))
    useCartStore.getState().addListing(makeListing({ id: '2', listing_id: 'PD-00002', price_kes: 30000 }))
  ...
  test('getDepositTotal sums deposits for preorder items only (5% < 70k)', () => {
    ...
    useCartStore.getState().addListing(
      makeListing({ listing_id: 'PD-00001', price_kes: 50000, is_preorder: false })
    )
    // Preorder, under 70k — 5% deposit = 2500
    useCartStore.getState().addListing(
      makeListing({ id: '2', listing_id: 'PD-00002', price_kes: 50000, is_preorder: true })
    )
  ...
  test('getDepositTotal sums deposits for preorder items (10% >= 70k)', () => {
    ...
    useCartStore.getState().addListing(
      makeListing({ id: '1', listing_id: 'PD-00001', price_kes: 70000, is_preorder: true })
    )
    // Preorder, above 70k — 10% deposit = 10000
    useCartStore.getState().addListing(
      makeListing({ id: '2', listing_id: 'PD-00002', price_kes: 100000, is_preorder: true })
    )
