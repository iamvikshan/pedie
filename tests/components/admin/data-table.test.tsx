...
const { DataTablePagination } =
  await import('@components/admin/dataTablePagination')
const { DataTableToolbar } = await import('@components/admin/dataTableToolbar')
const { DataTableColumnHeader } =
  await import('@components/admin/dataTableColumnHeader')
