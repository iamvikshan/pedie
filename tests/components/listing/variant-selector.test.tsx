...
describe("Variant Selector Component", () => {
  const componentPath = join(process.cwd(), "src/components/listing/variantSelector.tsx");
...
describe("findBestMatch", () => {
  const mockListings: Listing[] = [
    {
      id: "1", listing_id: "l1", product_id: "p1",
      storage: "128GB", color: "Black", carrier: "Unlocked", condition: "excellent", battery_health: null,
      price_kes: 50000, final_price_kes: 50000, original_price_usd: 500, landed_cost_kes: 45000,
      source: null, source_listing_id: null, source_url: null, images: null,
      is_featured: false, listing_type: "standard", ram: null, status: "available",
      sheets_row_id: null, notes: null, created_at: "", updated_at: ""
    },
    {
       id: "2", listing_id: "l2", product_id: "p1",
       storage: "256GB", color: "Black", carrier: "Unlocked", condition: "excellent", battery_health: null,
       price_kes: 60000, final_price_kes: 60000, original_price_usd: 600, landed_cost_kes: 55000,
       source: null, source_listing_id: null, source_url: null, images: null,
       is_featured: false, listing_type: "standard", ram: null, status: "available",
       sheets_row_id: null, notes: null, created_at: "", updated_at: ""
    },
    {
       id: "3", listing_id: "l3", product_id: "p1",
       storage: "256GB", color: "White", carrier: "Unlocked", condition: "good", battery_health: null,
       price_kes: 55000, final_price_kes: 55000, original_price_usd: 550, landed_cost_kes: 50000,
       source: null, source_listing_id: null, source_url: null, images: null,
       is_featured: false, listing_type: "standard", ram: null, status: "available",
       sheets_row_id: null, notes: null, created_at: "", updated_at: ""
    }
