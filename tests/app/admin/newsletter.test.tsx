...
const { newsletterColumns } =
  await import('@/app/(admin)/admin/newsletter/columns')
const { NewsletterExportButton } =
  await import('@components/admin/newsletterExportButton')
...
describe('Admin Newsletter', () => {
  ...
  describe('NewsletterExportButton', () => {
    test('renders export CSV button', () => {
      const html = renderToString(React.createElement(NewsletterExportButton))
