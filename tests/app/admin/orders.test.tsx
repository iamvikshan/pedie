...
const { orderColumns } = await import('@/app/admin/orders/columns')
const { OrderStatusUpdater } = await import(
  '@components/admin/order-status-updater'
)
const { TrackingForm } = await import('@components/admin/tracking-form')
