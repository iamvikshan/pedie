...
const { default: AccountDashboard } =
  await import('@/app/(account)/account/page')
const { default: OrdersListPage } =
  await import('@/app/(account)/account/orders/page')
const { default: OrderDetailPage } =
  await import('@/app/(account)/account/orders/[id]/page')
const { default: WishlistPage } =
  await import('@/app/(account)/account/wishlist/page')
const { default: AccountLayout } =
  await import('@/app/(account)/account/layout')
