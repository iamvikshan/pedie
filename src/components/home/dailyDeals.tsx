...
export function DailyDeals({ listings }: DailyDealsProps) {
  ...
  return (
    <motion.section
      className='py-16 bg-pedie-card/50 border-y border-pedie-border'
      ...
      <div className='container mx-auto px-4 md:px-6'>
        <div className='flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4'>
          <div className='flex items-center gap-3'>
            <TbFlame
              className='w-7 h-7 text-pedie-discount'
              aria-hidden='true'
            />
          ...
          <div className='flex flex-col items-end gap-1'>
            <div className='flex items-center gap-2 text-pedie-text'>
              ...
              <div className='flex gap-2'>
                <div className='glass rounded-lg border border-pedie-border px-2 py-1 min-w-[40px] text-center font-mono font-bold'>
                ...
                <span className='font-bold'>:</span>
                <div className='glass rounded-lg border border-pedie-border px-2 py-1 min-w-[40px] text-center font-mono font-bold text-pedie-discount'>
                  {timeLeft.seconds.toString().padStart(2, '0')}
                </div>
              </div>
            </div>
            <p className='text-xs text-pedie-discount font-medium'>
              {URGENCY_TEXT}
            </p>
          </div>
        </div>
